...
- **Rough is not mannered.** Roughing up means shorter sentences, a stated opinion, an uneven paragraph. It never means swapping a plain phrase for a figurative one; that's the mannered-prose tell, and the un-polish pass is where it sneaks in. Density counts too: if the rewrite is denser overall than the source, longer on average or with fewer paragraph breaks, undo that.

...
- **Strip the named tells.** Em-dash overuse, rule-of-three padding ("clear, concise, and compelling"), "it's not X, it's Y" scaffolds, filler openers ("That said", "It's worth noting"), corporate verbs (delve, leverage, elevate, unlock, seamless, robust, streamline), and closing sentences that restate the point. Kill them.

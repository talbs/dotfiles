...
| `.claude/skills/`            | Claude Code skills — `last-mile`, `once-over`, linked in individually         |
| `.claude/skills.work/`       | Work-only skills — linked in by `./install.sh work`, skipped on personal      |
